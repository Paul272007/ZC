...
- `-n, --newheader` : generate a header based on the given c file(s)
...
- `9` : an error occurred while moving the library file into its destination directory.
- `10` : an error occurred while moving the header file into its destination directory.
...
- `17` : the configuration file was not found.
- `18` : the configuration file contains invalid JSON.
- `19` : no main function found in the provided files.
